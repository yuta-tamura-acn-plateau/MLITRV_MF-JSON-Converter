...
################################################################################
## Form generated from reading UI file 'SampleForm.ui'
##
...
class Ui_MainFormClass(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_hint = QLineEdit(self.centralwidget)
        self.lineEdit_hint.setObjectName(u"lineEdit_hint")

        self.verticalLayout_hint.addWidget(self.lineEdit_hint)
        ...
        self.pushButton_baclpage = QPushButton(self.centralwidget)
        self.pushButton_baclpage.setObjectName(u"pushButton_baclpage")

        self.horizontalLayout.addWidget(self.pushButton_baclpage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_browse.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
        self.pushButton_baclpage.setText(QCoreApplication.translate("MainWindow", u"back", None))
        self.pushButton_nextpage.setText(QCoreApplication.translate("MainWindow", u"next", None))
